...
function DiscordLib:Window(text,mainclr,cls)
	...
	local CloseBind = cls or Enum.KeyCode.   or _G.Toggle
...
AutoFarm:Toggle("Auto Farm Boss Quest", true, function(vu)
	BossQuest = vu
end)
...
AutoFarm:Toggle("Auto Buy EXP x2 [ Bone ]", false, function(vu)
    AutoBuyEXPBone = vu
end)
...
Setting:Slider("Level Lock", 1,2100,_G.LevelMax, function(value)
	LevelLock = value
end)
